  ...
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["@mapbox/mapbox-gl-style-spec", [\
        ["npm:13.23.1", {\
          "packageLocation": "./.yarn/cache/@mapbox-mapbox-gl-style-spec-npm-13.23.1-1a245cc52a-ea79fbf2cd.zip/node_modules/@mapbox/mapbox-gl-style-spec/",\
          "packageDependencies": [\
